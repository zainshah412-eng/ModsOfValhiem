package com.appcake.modsforvalheim.core.adapter.seeds
...
class SeedsAdapter(
    ...
    RecyclerView.Adapter<SeedsAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "seedsimage")
