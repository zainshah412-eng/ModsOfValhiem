package com.appcake.modsforvalheim.core.adapter.tools
...
class ToolsAdapter(
    ...
    RecyclerView.Adapter<ToolsAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "toolsimage")
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView(
                                        imageName!!,
                                        Constantdropbox.TOOLS_IMAGE_JSON_PATH_DROPBOX
                                    ) as String
