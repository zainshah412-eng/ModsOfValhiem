package com.appcake.modsforvalheim.core.adapter.character
...
class CharacterAdapter(
    ...
    val mCacheMods = Cache(contextSeed, cacheDirName = "characterimage")
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        with(viewHolder)
        {
            ...
            if (mCacheMods.isImageAvailableInCache(dataListFilter[position].imageId)) {
                ...
                Log.wtf("Path", dataListFilter[position].imageId)
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView(
                                        imageName!!,
                                        Constantdropbox.CHARAACTER_IMAGE_JSON_PATH_DROPBOX
                                    ) as String

//                        dataListFilter[position].imageUrl = imgUrl
//                        dataList[position].imageUrl = imgUrl
                    ...
                    Log.wtf("URL", dataListFilter[position].imageUrl)
                    Glide.with(contextSeed).load(dataListFilter[position].imageUrl)
                        .placeholder(R.drawable.progress_animation).error(R.drawable.progress_animation)
                        .into(seedImg)
                }
