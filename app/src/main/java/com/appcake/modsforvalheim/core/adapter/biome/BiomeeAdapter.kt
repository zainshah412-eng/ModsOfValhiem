package com.appcake.modsforvalheim.core.adapter.biome
...
class BiomeeAdapter(
    ...
    RecyclerView.Adapter<BiomeeAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "biomeimage")
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView(
                                        imageName!!,
                                        Constantdropbox.BIOME_IMAGE_JSON_PATH_DROPBOX
                                    ) as String
