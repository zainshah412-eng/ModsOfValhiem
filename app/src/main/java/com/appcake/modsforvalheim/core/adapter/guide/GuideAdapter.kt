package com.appcake.modsforvalheim.core.adapter.guide
...
class GuideAdapter(
    ...
    RecyclerView.Adapter<GuideAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "guideimage")
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView(
                                        imageName!!,
                                        Constantdropbox.GUIDES_IMAGE_JSON_PATH_DROPBOX
                                    ) as String
