package com.appcake.modsforvalheim.core.adapter.cheat
...
class DropDownCheatAdapter(
    ...
    override fun getGroupView(
        ...
        val lblListHeader = convertViewDD!!.findViewById<TextView>(R.id.tvDDTitle)
        ...
        lblListHeader.text = listDD[grouppositionDD].dropdownTitle
    ...
    override fun getChildView(
        ...
        btnCopyChats.setOnClickListener {
            ...
            val clipDD = ClipData.newPlainText("commands", listDD[grouppositionDD].dropdownDescription)
            clipboardDD.setPrimaryClip(clipDD)
