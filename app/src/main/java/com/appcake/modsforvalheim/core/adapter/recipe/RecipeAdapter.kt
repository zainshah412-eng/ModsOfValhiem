package com.appcake.modsforvalheim.core.adapter.recipe
...
class RecipeAdapter(
    ...
    val mCacheMods = Cache(contextSeed, cacheDirName = "recipeimage")
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView(
                                        imageName!!,
                                        Constantdropbox.RECIPE_IMAGE_JSON_PATH_DROPBOX
                                    ) as String
