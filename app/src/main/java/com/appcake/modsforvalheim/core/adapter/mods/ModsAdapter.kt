package com.appcake.modsforvalheim.core.adapter.mods
...
class ModsAdapter(
    ...
    RecyclerView.Adapter<ModsAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "modsimage")
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView1(
                                        imageName!!,
                                        //   Constantdropbox.MODS_IMAGE_JSON_PATH_DROPBOX
                                    ) as String
