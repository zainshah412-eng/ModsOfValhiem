package com.appcake.modsforvalheim.core.adapter.keys
...
class KeysAdapter(
    ...
    RecyclerView.Adapter<KeysAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "keysimage")
