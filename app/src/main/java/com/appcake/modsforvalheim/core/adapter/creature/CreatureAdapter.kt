package com.appcake.modsforvalheim.core.adapter.creature
...
class CreatureAdapter(
    ...
    RecyclerView.Adapter<CreatureAdapter.ViewHolder>(), Filterable {
    private var dataListFilter = ArrayList<ArmorData>()
    val mCacheMods = Cache(contextSeed, cacheDirName = "creeatureimage")
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            val imgUrl: String =
                                DropboxServices.getInstance(contextSeed.applicationContext)
                                    .loadImageToView(
                                        imageName!!,
                                        Constantdropbox.CREATURE_IMAGE_JSON_PATH_DROPBOX
                                    ) as String
